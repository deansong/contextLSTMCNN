...
#xcurrentall, xpreall, xlatall, yall, total= w2v.w2vdoc2fofesent(dataList, windowSize=options.windowsSize)
#allSentIds = range(len(xcurrentall))
#trainIDs = allSentIds
#testIDs = allSentIds
#
#if options.nFoldsSplit:
...
#    print(c_weight)
#    trainids, valids = train_test_split(trainIDs, test_size=0.1)
#
#    xtrainnew = xcurrentall[trainids]
#    xpretrain = xpreall[trainids]
#    xlattrain = xlatall[trainids]
#    ytrainnew = yall[trainids]
#
#    xvalnew = xcurrentall[valids]
#    xpreval = xpreall[valids]
#    xlatval = xlatall[valids]
#    yvalnew = yall[valids]
#
#    early_stopping = EarlyStopping(monitor='val_loss', patience=50)
#
#    print('blstmcnnFofe training...')
#    blstmcnnFofe = blstmcnn_docLevel_2(w2v.maxSentLen, w2v.ebd_size)
#    #blstmcnnFofe.fit([xtrainnew,xpretrain,xlattrain], ytrainnew, epochs=options.epochs, batch_size=64, class_weight = c_weight, validation_split=0.1, callbacks=[early_stopping])
#    blstmcnnFofe.fit([xtrainnew,xpretrain,xlattrain], ytrainnew, epochs=options.epochs, batch_size=64, validation_data=([xvalnew, xpreval, xlatval], yvalnew), callbacks=[early_stopping], class_weight=c_weight)
#
#    print('blstmcnn training...')
#    blstmcnn = blstmcnn_sentLevel_2(w2v.maxSentLen, w2v.ebd_size)
#    #blstmcnn.fit(xtrainnew, ytrainnew, epochs=options.epochs, batch_size=64, class_weight = c_weight, validation_split=0.1, callbacks=[early_stopping])
#    blstmcnn.fit(xtrainnew, ytrainnew, epochs=options.epochs, batch_size=64, validation_data=(xvalnew,yvalnew) , callbacks=[early_stopping], class_weight=c_weight)
#
#    print('blstm only training...')
#    blstmOnly = blstm_only(w2v.maxSentLen, w2v.ebd_size)
#    blstmOnly.fit(xtrainnew, ytrainnew, epochs=options.epochs, batch_size=64, validation_data=(xvalnew,yvalnew) , callbacks=[early_stopping], class_weight=c_weight)
#
#
#    print('cnnFofe training...')
#    cnnFofe = cnn_fofe(w2v.maxSentLen, w2v.ebd_size)
#    cnnFofe.fit([xtrainnew,xpretrain,xlattrain], ytrainnew, epochs=options.epochs, batch_size=64, class_weight=c_weight, validation_data=([xvalnew, xpreval, xlatval], yvalnew), callbacks=[early_stopping])
#
#    print('cnn only training')
#    cnnOnly = cnn_only(w2v.maxSentLen, w2v.ebd_size)
#    cnnOnly.summary()
#    cnnOnly.fit(xtrainnew, ytrainnew, epochs=options.epochs, batch_size=64, validation_data=(xvalnew,yvalnew) , callbacks=[early_stopping], class_weight=c_weight)
#
#
#
#
#if options.test:
#    xtestnew = xcurrentall[testIDs]
#    xpretest = xpreall[testIDs]
#    xlattest = xlatall[testIDs]
#    ytestnew = yall[testIDs]
#    blstmcnnfofescores = blstmcnnFofe.evaluate([xtestnew,xpretest,xlattest],ytestnew, verbose=0)
#    #blstmcnnfofepredict = blstmcnnFofe.predict([xtestnew,xpretest,xlattest])
#    print('blstmcnnfofescores')
#    print(blstmcnnfofescores)
#    #Evaluation(w2v.usedLabels, blstmcnnfofepredict ,ytestnew)
#
#    blstmcnnscores = blstmcnn.evaluate(xtestnew,ytestnew, verbose=0)
#    #blstmcnnpredict = blstmcnn.predict(xtestnew)
#    print('blstmcnnscores')
#    print(blstmcnnscores)
#    #Evaluation(w2v.usedLabels, blstmcnnpredict ,ytestnew)
#
#    #blstmcnnfofePreOnlyscores = blstmcnnFofePreOnly.evaluate([xtestnew,xpretest],ytestnew, verbose=0)
#    #blstmcnnfofePreOnlypredict = blstmcnnFofePreOnly.predict([xtestnew,xpretest])
#    #print('blstmcnnfofePreOnlyscores')
#    #print(blstmcnnfofePreOnlyscores)
#    #Evaluation(w2v.usedLabels, blstmcnnfofePreOnlypredict ,ytestnew)
#
#    blstmOnlyScores = blstmOnly.evaluate(xtestnew,ytestnew, verbose=0)
#    #blstmOnlypredict = blstmOnly.predict(xtestnew)
#    print('blstmOnlyScores')
#    print(blstmOnlyScores)
#    #Evaluation(w2v.usedLabels, blstmOnlypredict ,ytestnew)
#
#    cnnOnlyScores = cnnOnly.evaluate(xtestnew,ytestnew, verbose=0)
#    cnnOnlypredict = cnnOnly.predict(xtestnew)
#    print('cnnOnlyScores')
#    print(cnnOnlyScores)
#
#    cnnfofescores = cnnFofe.evaluate([xtestnew,xpretest,xlattest],ytestnew, verbose=0)
#    #cnnfofepredict = cnnFofe.predict([xtestnew,xpretest,xlattest])
#    print('cnnfofescores')
#    print(cnnfofescores)
#    #Evaluation(w2v.usedLabels, cnnfofepredict ,ytestnew)
#
#
